...
import { isW3CSession, filterCapabilities } from '../helpers/utilities'
import { W3C_CAPABILITIES, JSONWP_CAPABILITIES } from '../helpers/constants';
...
export default function init (desiredCapabilities = {}) {
    ...
    return this.requestHandler.create({
        ...
        capabilities: { alwaysMatch: filterCapabilities(this.desiredCapabilities, W3C_CAPABILITIES), firstMatch: [{}] },
        desiredCapabilities: filterCapabilities(this.desiredCapabilities, JSONWP_CAPABILITIES)
    }).then((response) => {
        this.requestHandler.isW3C = isW3CSession(response.value)
